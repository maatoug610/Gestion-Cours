...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand"><img src="https://th.bing.com/th/id/OIP.inkXu72f1Z3UpCP65xyiegAAAA?w=166&h=180&c=7&o=5&pid=1.7" width="20px" heigth="20px">Gestion Diplome</a>
    ...
    <div class="collapse navbar-collapse">
      ...
      <div class="container">
        <a class="btn btn-success" aria-current="page" href="{{ url('/diplome/create') }}">Create</a>
     </div>
      </div>
    </div>
  </div>
...
<div class="card mb-3" style="width:1300px;">
  <img src="https://th.bing.com/th/id/OIP.CKWjElpNzWWfuNTzAct-jAHaEF?w=309&h=180&c=7&o=5&pid=1.7" class="card-img-top" alt=".." style="height:200px;">
  <div class="card-body ">
    <h5 class="card-title">List of Diplome</h5>
    <p class="card-text">You Can Find the informations about Diplomes in the system.</p>

    <table class="table">
  <thead class="table-dark">
    <tr>
      <th scope="col">ID</th>
      <th scope="col">Coef Diplome</th>
      <th scope="col">Nom Diplome</th>
    ...
    <tr>
       ...
       <td>
         <form method="post" action="{{ route('diplome.destroy',$diplome->id) }}">
           ...
           <a href="{{ route('diplome.edit',$diplome->id) }}" >
