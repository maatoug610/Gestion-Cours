...
<section class="col">
            <form action="url('diplome/{diplome}'.$diplome->id)" method="post">
                 @csrf
                 <div>
                 <div class="container">
                     ...
                     <div class="col-md-7 mt-2 pt-5">
                       ...
                       <div class="col-sm-8 bg-dark">
                         ...
                         <div class="">
                          ...
                          <h5 class="text-white"><i class="text-Warning">ID Diplome: </i>{{ $diplomes->id }}</h5>
                          <h5 class="text-white"><i class="text-Warning">Coef Diplome:</i> {{ $diplomes->coef_diplome }} </h5>
                  
                         </div>
                         <h4 class="mt-3 text-center text-danger "><i class="fa fa-briefcase"></i>Other's</h4>
                         <hr class="bg-info mt-0 w-25">
                         <div class="">
                           <h3 class="text-white"><i class="text-Warning">Nom Diplome: </i>{{ $diplomes->nom }}</h3>
                         </div>
