...
<div class="wrapper">
  ...
  <div class="container-fluid">
    <a class="navbar-brand"><img src="https://th.bing.com/th/id/OIP.inkXu72f1Z3UpCP65xyiegAAAA?w=166&h=180&c=7&o=5&pid=1.7" width="20px" heigth="20px">Gestion d'Etudiant</a>
      <span class="navbar-toggler-icon"></span>
    </button>
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">

        <a class="nav-link active" aria-current="page" href="{{ url('/etudiant/create') }}">Create</a>
...
<section class="col">
            <form action="url('etudiant/{etudiant}'.$etudiant->id)" method="post">
                 @csrf
                 <div>
                 <div class="container">
                     ...
                     <div class="col-md-7 mt-2 pt-5">
                       ...
                       <div class="col-sm-8 bg-dark">
                         ...
                         <div class="">
                          ...
                          <h5 class="text-white"><i class="text-Warning">Cin: </i>{{ $etudiants->cin }}</h5>
                          <h5 class="text-white"><i class="text-Warning">Adresse:</i> {{ $etudiants->adresse }} </h5>
                          
                          <h5 class="text-white"><i class="text-Warning">Nom:</i> {{ $etudiants->nom }}</h5>
                          <h5 class="text-white"><i class="text-Warning">Prenom:</i> {{ $etudiants->prenom }}</h5>
                         ...
                         <div class="">
                           <h3 class="text-white"><i class="text-Warning">Mail: </i>{{ $etudiants->mail }} </h3>
                         </div>
                         <div class="">
                           <h3 class="text-white"><i class="text-Warning">Telephone:</i> {{ $etudiants->tel }}  </h3>
                         </div>
                         <div class="">
                         <h3 class="text-white"><i class="text-Warning">Diplome:</i> {{ $etudiants->diplome->nom }}  </h3>
                         </div>
                       </div>
                       </div>
                     </div>
