...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand"><img src="https://th.bing.com/th/id/OIP.inkXu72f1Z3UpCP65xyiegAAAA?w=166&h=180&c=7&o=5&pid=1.7" width="20px" heigth="20px">Gestion d'Etudiants</a>
    ...
    <div class="collapse navbar-collapse">
      ...
      <div class="container">
        <a class="btn btn-success" aria-current="page" href="{{ url('/etudiant/create') }}">Create</a>
     </div>
      </div>
    </div>
  </div>
...
<div class="card mb-3" style="width:1300px;">
  ...
  <div class="card-body ">
    <h5 class="card-title">List of Etudiants</h5>
    <p class="card-text">You Can Find the informations about Etudiants in the system.</p>
