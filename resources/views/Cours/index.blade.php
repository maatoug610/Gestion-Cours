...
<div class="card mb-3" style="width:1300px;">
  ...
  <div class="card-body ">
    <h5 class="card-title">List of Enseignants</h5>
    <p class="card-text">You Can Find the informations about Enseignants in the system.</p>
  ...
  <tbody>
    ...
    <tr>
       ...
       <td>{{ $enseignant->N_bureau }}</td>
       <td>{{ $enseignant->tel }}</td>
       <td>
           <a href="{{ route('enseignant.show',$enseignant->id) }}" class="btn btn-sm btn-info">Show</a>
           <a href="{{ route('enseignant.edit',$enseignant->id) }}" class="btn btn-sm btn-warning">Edit</a>
           <a href="{{ route('enseignant.destroy',$enseignant->id) }}" class="btn btn-sm btn-danger">✘</a>
       </td>
    </tr>
    @endforeach
  </tbody>
